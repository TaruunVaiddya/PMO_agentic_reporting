          ...
          <Card className="border-none inset bg-card/50 backdrop-blur-xl rounded-3xl shadow-2xl">
            ...
            <CardContent className="space-y-6">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-background border-border text-foreground placeholder:text-muted-foreground focus:border-ring rounded-xl h-12 px-4 transition-all duration-200 mt-1.5"
                  />
                </div>
              ...
              <p className="text-center text-sm text-muted-foreground">
                ...
                <Link href="/signup" className="font-medium text-foreground hover:underline transition-colors">
                  Sign up for free
                </Link>
              </p>
            </CardContent>
